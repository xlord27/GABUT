...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/etc/ssh/.ssh.db")
    ...
    echo -e " \e[1;97;101m         LIST MEMBER SSH           \e[0m"
    echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo ""
  ...
  echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
  echo -e "  \e[1;97;101m        DATA AKUN SSH         \E[0m"
  echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
        echo "     No  Expired   User"
        $(grep -c -E "^### " "/etc/ssh/.ssh.db")| cut -d ' ' -f 2-3 | nl -s ') '
...
harini=$(grep -E "^### " "/etc/ssh/.ssh.db") | cut -d ' ' -f 4 | sed -n "${CLIENT_NUMBER}"p)
exp=$(grep -E "^### " "/etc/ssh/.ssh.db") | cut -d ' ' -f 3 | sed -n "${CLIENT_NUMBER}"p)
uuid=$(grep -E "^### " "/etc/ssh/.ssh.db") | cut -d ' ' -f 5 | sed -n "${CLIENT_NUMBER}"p)
if [[ ${c} != "0" ]]; then
