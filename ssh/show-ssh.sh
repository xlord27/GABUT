...
————————————————————————————————————${NC}"
grep -E "###! " "/etc/ssh/.ssh.db"

clear
NUMBER_OF_CLIENTS=$(grep -E "^### " "/etc/ssh/.ssh.db")
...
export user=$(grep -E "^### " "/etc/ssh/.ssh.db") | cut -d ' ' -f 2 | sed -n "${CLIENT_NUMBER}"p)
export harini=$(grep -E "^### " "/etc/ssh/.ssh.db") | cut -d ' ' -f 4 | sed -n "${CLIENT_NUMBER}"p)
export exp=$(grep -E "^### " "/etc/ssh/.ssh.db") | cut -d ' ' -f 3 | sed -n "${CLIENT_NUMBER}"p)
export uuid=$(grep -E "^### " "/etc/ssh/.ssh.db") | cut -d ' ' -f 5 | sed -n "${CLIENT_NUMBER}"p)
