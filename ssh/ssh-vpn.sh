...
wget -O menu-vmess "https://raw.githubusercontent.com/xlord27/lowq/main/xray/menu-vmess.sh"
wget -O menu-vless "https://raw.githubusercontent.com/xlord27/lowq/main/xray/menu-vless.sh"
