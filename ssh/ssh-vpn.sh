...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/xlord27/gabut/main/issue.net"
...
wget -O add-host "https://raw.githubusercontent.com/xlord27/lowq/main/ssh/add-host.sh"
