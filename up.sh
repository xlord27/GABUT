...
wget -O menu-vmess "https://raw.githubusercontent.com/xlord27/lowq/main/menu/menu-vmess.sh"
wget -O menu-vless "https://raw.githubusercontent.com/xlord27/lowq/main/menu/menu-vless.sh"
...
wget -O menu-trojan "https://raw.githubusercontent.com/xlord27/lowq/main/menu/menu-trojan.sh"
...
wget -O menu-backup "https://raw.githubusercontent.com/xlord27/gabut/main/backup/menu-backup.sh"
...
wget -q -O /usr/bin/up "https://raw.githubusercontent.com/xlord27/gabut/main/up.sh" && chmod +x /usr/bin/up
wget -q -O /usr/bin/fix "https://raw.githubusercontent.com/xlord27/gabut/main/menu/fix.sh" && chmod +x /usr/bin/fix
