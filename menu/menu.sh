...
clear
echo -e "$COLOR1┌──────────────────────────────────────────────────┐${NC}" 
echo -e "$COLOR1│  ${NC}            << XLORD VPN STORE >>               $COLOR1│ ${NC}"
echo -e "$COLOR1└──────────────────────────────────────────────────┘${NC}" 
echo -e " $COLOR1┌──────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 │${NC} ✪$bd OS NAME   : \033[0;32m$cname${NC}"
echo -e "$COLOR1 │${NC} ✪$bd Use Core     : \033[0;32mSIMPEL MODE${NC}"
echo -e "$COLOR1 │${NC} ✪$bd RAM VPS    : \033[0;32m${totalram} MB${NC}"
echo -e "$COLOR1 │${NC} ✪$bd IP VPS      : \033[0;32m$IPVPS${NC}"
echo -e "$COLOR1 │${NC} ✪$bd DATE        : \033[0;32m$DATEVPS${NC}"
echo -e "$COLOR1 │${NC} ✪$bd UPTIME      : \033[0;32m$SERONLINE${NC}"
echo -e "$COLOR1 │${NC} ✪$bd CITY          : \033[0;32m$CITY${NC}"
echo -e "$COLOR1 │${NC} ✪$bd ISP VPS      : \033[0;32m$ISP${NC}"  
echo -e "$COLOR1 │${NC} ✪$bd Current Domain  : \033[0;32m$domain${NC}"
echo -e "$COLOR1 │${NC} ✪$bd Status Hari ini  : \033[31;1m𝗝𝗔𝗡𝗚𝗔𝗡 𝗟𝗨𝗣𝗔 𝗦𝗛𝗢𝗟𝗔𝗧${NC}"
echo -e "$COLOR1 └──────────────────────────────────────────────────┘${NC}" 
...
datediff() {
    d1=$(date -d "$1" +%s)
    d2=$(date -d "$2" +%s)
    echo -e " $COLOR1│$NC  $COLOR1Expiry In     : $(( (d1 - d2) / 86400 )) Days $NC"
}
mai="datediff "$Exp" "$DATE""
echo -e " $COLOR1┌─────────────────────────────────────┐${NC}"
echo -e " $COLOR1│${NC}   Version        : $(cat /opt/.ver) Last Update ${NC}"
echo -e " $COLOR1│${NC}   User           :\033[1;36m $Name \e[0m"
