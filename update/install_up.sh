...
wget -q -O /usr/bin/menu-vmess "https://raw.githubusercontent.com/xlord27/gabut/main/menu/menu-vmess.sh" && chmod +x /usr/bin/menu-vmess
wget -q -O /usr/bin/menu-vless "https://raw.githubusercontent.com/xlord27/gabut/main/menu/menu-vless.sh" && chmod +x /usr/bin/menu-vless
