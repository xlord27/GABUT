...
sleep 2
clear
wget https://raw.githubusercontent.com/xlord27/gabut/main/nginx-ssl.sh && chmod +x nginx-ssl.sh && ./nginx-ssl.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/xlord27/xlord-udp/main/xlord/udp.sh && bash udp.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
echo " "
echo "=====================-[ PEMASANGAN BERHASIL BOSQU.. ]-===================="
echo ""
echo "------------------------------------------------------------"
echo ""
echo ""
